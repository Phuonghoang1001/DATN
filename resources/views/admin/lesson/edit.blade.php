    ...
    <div id="main-content-wp" class="add-cat-page">
        <div class="section" id="title-page">
            <div class="clearfix">
                ...
                <h3 id="index" class="fl-left">Sửa <small>{{$lesson ->lesson_name}}</small></h3>
            </div>
        </div>
            ...
            <div id="content" class="fl-right">
                <div class="section" id="detail-page">
                    <div class="section-detail">
                        ...
                        @endif
                        <form method="POST" action="admin/lesson/edit/{{$lesson->id}}" enctype="multipart/form-data">
                            ...
                            <textarea class="ckeditor" name="lesson_content" id="lesson_content">{{$lesson->lesson_content}}</textarea>
